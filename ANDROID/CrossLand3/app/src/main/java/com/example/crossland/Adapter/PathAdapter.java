...
public class PathAdapter extends RecyclerView.Adapter<PathAdapter.MyViewHolder> {
    ...
    @NonNull
    @Override
    public PathAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.inter_items, viewGroup, false);
        return new PathAdapter.MyViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull PathAdapter.MyViewHolder myViewHolder, int i) {
