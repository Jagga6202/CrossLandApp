...
$query = "SELECT * FROM crosslandtable";
...
if (!empty($_POST)) {
    ...
    function send_gcm_notify($reg_id, $message, $img_url, $tag) {
        ...
        define("GOOGLE_API_KEY", "AAAASKeFIPM:APA91bFmefcy-cP6breQPZoUzoEXWZJkI-pxZReD2KhqxVuCGaxATFiqsLON9UXJRtjwRzKCBt6LOMpaKOrJNwu1gKSQejgTtUef1i1jcxsKzE0Sr6QpOIp5xcnwo5mEvtYu970K_Sby");
        ...
        $fields = array(
            ...
            'to'  						=> $reg_id ,
            'priority'					=> "high",
            'data'						=> array("title" => "CROSSLAND", "message" => $message, "image"=> $img_url, "tag" => $tag)
        );
    ...
    if ($_FILES['image']['name'] != '') {
        ...
        $img_url = 'http://avneet6202.000webhostapp.com/crorrlandapp/'.$target_file;
            ...
            <div class="input-field col s12">
                <select name="fcm_id" required>
                    ...
                    <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        echo "<option value='".$row['fcm_id']."'>".$row['name']." &lt;".$row['email']."&gt;</option>";
                    } ?>
                </select><br><br>
